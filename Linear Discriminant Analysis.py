...
lda = lda(n_components=2)   # 2 independant variables considered as we wish to visualize the results
X_train = lda.fit_transform(X_train,y_train) # supervised technique
